import { f as createComponent, r as renderTemplate, k as renderComponent, l as renderScript, m as maybeRenderHead } from '../chunks/astro/server_DHY1K0at.mjs';
import 'kleur/colors';
import 'html-escaper';
import { $ as $$AuthLayout } from '../chunks/AuthLayout_C_ryXf5v.mjs';
...
Copyright © 2021-${(/* @__PURE__ */ new Date()).getFullYear()} <a href="https://codepen.io/uidesignhub" rel="" target="_blank" title="Ajimon" class="text-green hover:text-green-500">AJI</a></span> </div> </div> </div> ` })} ${renderScript($$result, "C:/Users/jordi/Desktop/Astro/07-store/src/pages/register.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/jordi/Desktop/Astro/07-store/src/pages/register.astro", undefined);

const $$file = "C:/Users/jordi/Desktop/Astro/07-store/src/pages/register.astro";
const $$url = "/register";
