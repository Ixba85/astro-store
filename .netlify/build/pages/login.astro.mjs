...
Copyright © 2021-${(/* @__PURE__ */ new Date()).getFullYear()} <a href="https://codepen.io/uidesignhub" rel="" target="_blank" title="Ajimon" class="text-green hover:text-green-500">AJI</a></span> </div> </div> </div> ` })} ${renderScript($$result, "C:/Users/jordi/Desktop/Astro/07-store/src/pages/login.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/jordi/Desktop/Astro/07-store/src/pages/login.astro", undefined);

const $$file = "C:/Users/jordi/Desktop/Astro/07-store/src/pages/login.astro";
const $$url = "/login";
